    ...
    <>
      {auth.state === STATE.HAS_VALUE && (
        <header
          ...
          className='animate-fadeIn fixed z-50 flex flex-col items-center justify-center w-screen bg-white border-b-1 border-gray-200 border-solid h-28 flex-wrap'
        >
          <section className='container flex flex-row justify-between mx-auto w-screen'>
            <BrandImageComponent />
            <ContentHeaderComponent />
          </section>
          <section className='h-2 w-full top-28 absolute '>
            <div
