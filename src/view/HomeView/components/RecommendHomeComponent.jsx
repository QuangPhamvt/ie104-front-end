...
export const RecommendToDayItemHomeComponent = (props) => {
  ...
  return (
    <div className='flex flex-col justify-center items-center space-y-4 object-contain home--content-hidden cart--recommend-mind'>
      <img
  ...
  return (
    <article className='container mx-auto flex flex-col space-y-28'>
      <section className='flex flex-col space-y-14'>
        <h2 className='font-medium home--content-hidden'>What&rsquo; on your mind</h2>
