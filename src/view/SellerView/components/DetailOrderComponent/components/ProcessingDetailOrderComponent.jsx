// const ProcessingDetailOrderComponent = () => {
//   return <div>Processing Detail Order Component</div>
// }

// export default ProcessingDetailOrderComponent
...
const HeaderListProductListComponent = () => {
  ...
  return (
    <section className='flex flex-row pb-2 border-b-1 border-solid border-gray-500'>
      <div className='text-2xl font-bold'>{t('DETAIL_ORDERED.PROCESSING_DETAIL')}</div>
    </section>
  )
}
