...
import { openDialogStateCreateProductAtom, statusCreateProductAtom } from '..'
import { STATUS_API_POST } from '@/utilities'

export const DialogCreateProductComponent = (props) => {
  // eslint-disable-next-line react/prop-types
  const { open = false } = props
  const dialogRef = React.useRef(null)
  const { status, message } = useRecoilValue(statusCreateProductAtom)
  const setOpen = useSetRecoilState(openDialogStateCreateProductAtom)
