// Author: https://codepen.io/Hyperplexed/pen/OJdpEME
let start = new Date().getTime()

export const originPosition = { x: 0, y: 0 }
...
export const updateLastMousePosition = (position) => (last.mousePosition = position)
